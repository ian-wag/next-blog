...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      {error && <p className="text-xs text-red-500">All fiends are required</p>}
      <div className="mt-8">
        <button
          type="button"
          onClick={handleCommentSubmission}
          className="transition duration-100 ease hover:bg-indigo-900 bg-blue-600 text-lg rounded-full text-white px-8 py-3 inline-block cursor-pointer"
        >
          Post Comment
        </button>
        {showSuccessMessage && (
